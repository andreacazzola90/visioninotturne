...
class DPPPP_DpPortfolioPostsPro extends DiviExtension {
	 ...
	 * @var string
	 */
	public $gettext_domain = 'dpppp-dp-portfolio-posts-pro';
	 ...
	 * @var string
	 */
	public $name = 'dp-portfolio-posts-pro';
	 ...
	 * @var string
	 */
	public $version = DPPPP_VERSION;

	/**
	 * DPPPP_DpPortfolioPostsPro constructor.
	 *
	 * @param string $name
	 * @param array $args
	 */
	public function __construct( $name = 'dp-portfolio-posts-pro', $args = array() ) {
