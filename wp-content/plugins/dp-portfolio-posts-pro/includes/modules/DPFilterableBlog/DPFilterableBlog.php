...
class ET_Builder_Module_DP_Filterable_Blog extends ET_Builder_Module {
	...
	public function init() {
		$this->name             = __( 'DP Filterable Blog', 'dpppp-dp-portfolio-posts-pro' );
	...
	public function get_settings_modal_toggles() {
		return array(
			'general'  => array(
				'toggles' => array(
					'content'      => esc_html__( 'Query Arguments', 'dpppp-dp-portfolio-posts-pro' ),
					'elements'     => esc_html__( 'Posts Elements', 'dpppp-dp-portfolio-posts-pro' ),
					'filters'      => __( 'Filters Options', 'dpppp-dp-portfolio-posts-pro' ),
	...
	public function get_advanced_fields_config() {
		return array(
			'fonts'      => array(
				'filter'            => array(
					'label'           => __( 'Filter', 'dpppp-dp-portfolio-posts-pro' ),
				...
				'filter_active'     => array(
					'label'           => __( 'Filter Active', 'dpppp-dp-portfolio-posts-pro' ),
					'hide_text_align' => true,
					'css'             => array(
				...
				'pagination'        => array(
					'label'       => __( 'Pagination', 'dpppp-dp-portfolio-posts-pro' ),
					'css'         => array(
	...
	public function get_custom_css_fields_config() {
		return array(
			'portfolio_filters'       => array(
				'label'    => __( 'Portfolio Filters', 'dpppp-dp-portfolio-posts-pro' ),
				'selector' => '%%order_class%% .et_pb_portfolio_filters li a',
			),
			'active_portfolio_filter' => array(
				'label'    => __( 'Active Portfolio Filter', 'dpppp-dp-portfolio-posts-pro' ),
				'selector' => '%%order_class%% .et_pb_portfolio_filters li a.active',
			),
	...
	public function get_fields() {
		return array(
			...
			'taxonomy_tags'                 => array(
				...
				'default'     => 'post_tag',
				'show_if'     => array( 'custom_query' => 'off' ),
				'description' => __( 'Here you can control which taxonomy the include/exclude tags apply to. Leave empty for posts atgs. For other CPTs, enter the taxonomy name above. For projects, the tags name is project_tag', 'dpppp-dp-portfolio-posts-pro' ),
				'tab_slug'    => 'general',
				'toggle_slug' => 'content',
			),
			'include_tags'                  => array(
			...
			'default_filter'                => array(
				'label'           => __( 'Default Filter', 'dpppp-dp-portfolio-posts-pro' ),
				'type'            => 'text',
				'option_category' => 'configuration',
				'default'         => '',
				'description'     => __( 'Enter the id of the filter term you want to use as default. Leave empty to use All as default filter.', 'dpppp-dp-portfolio-posts-pro' ),
				'tab_slug'        => 'general',
				'toggle_slug'     => 'filters',
			),
			'filters_sort'                  => array(
				'label'           => __( 'Filters Sort', 'dpppp-dp-portfolio-posts-pro' ),
				'type'            => 'select',
				'option_category' => 'configuration',
				'options'         => array(
					'default'    => __( 'Default', 'dpppp-dp-portfolio-posts-pro' ),
					'properties' => __( 'ID, Name, Slug, Menu Order', 'dpppp-dp-portfolio-posts-pro' ),
					'custom'     => __( 'Custom', 'dpppp-dp-portfolio-posts-pro' ),
				),
				'default'         => 'default',
				'description'     => __( 'Choose which method to sort the filters', 'dpppp-dp-portfolio-posts-pro' ),
				'tab_slug'        => 'general',
				'toggle_slug'     => 'filters',
			),
			'filters_by'                    => array(
				'label'           => __( 'Filters By', 'dpppp-dp-portfolio-posts-pro' ),
				'type'            => 'select',
				'option_category' => 'configuration',
				'options'         => array(
					'id'         => __( 'ID', 'dpppp-dp-portfolio-posts-pro' ),
					'name'       => __( 'Name', 'dpppp-dp-portfolio-posts-pro' ),
					'slug'       => __( 'Slug', 'dpppp-dp-portfolio-posts-pro' ),
					'term_group' => __( 'Menu Order', 'dpppp-dp-portfolio-posts-pro' )
				),
				'default'         => 'id',
				'show_if'         => array( 'filters_sort' => 'properties' ),
				'description'     => __( 'Choose how to sort the filters', 'dpppp-dp-portfolio-posts-pro' ),
				'tab_slug'        => 'general',
				'toggle_slug'     => 'filters',
			),
			'filters_order'                 => array(
				'label'           => __( 'Filters Order', 'dpppp-dp-portfolio-posts-pro' ),
				'type'            => 'select',
				'option_category' => 'configuration',
				'options'         => array(
					'ASC'  => __( 'Asc', 'dpppp-dp-portfolio-posts-pro' ),
				...
				'default'         => 'ASC',
				'show_if'         => array( 'filters_sort' => 'properties' ),
				'show_if_not'     => array( 'filters_by' => 'term_group' ),
				'description'     => __( 'Choose which order to display the filters', 'dpppp-dp-portfolio-posts-pro' ),
				'tab_slug'        => 'general',
				'toggle_slug'     => 'filters',
			),
			'filters_custom'                => array(
				'label'           => __( 'Filters Custom', 'dpppp-dp-portfolio-posts-pro' ),
				'type'            => 'textarea',
				'option_category' => 'configuration',
				'description'     => __( 'Enter a comma-separated list of categories from the selected Categories above. Categories will appear in the order you enter them.', 'dpppp-dp-portfolio-posts-pro' ),
				'show_if'         => array( 'filters_sort' => 'custom' ),
				'tab_slug'        => 'general',
				'toggle_slug'     => 'filters',
			),
			'hide_all'                      => array(
				'label'           => __( 'Hide All Filter Button', 'dpppp-dp-portfolio-posts-pro' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
					'off' => __( 'No', 'dpppp-dp-portfolio-posts-pro' ),
			...
			'all_text'                      => array(
				'label'           => __( 'All Text', 'dpppp-dp-portfolio-posts-pro' ),
				'type'            => 'text',
				'option_category' => 'configuration',
				'default'         => __( 'All', 'dpppp-dp-portfolio-posts-pro' ),
				'show_if'         => array( 'hide_all' => 'off' ),
				'description'     => __( 'Here you can change the default text use for the All filter button.', 'dpppp-dp-portfolio-posts-pro' ),
				'tab_slug'        => 'general',
				'toggle_slug'     => 'filters',
			),
			'use_filters_url'               => array(
				'label'           => __( 'Add Active Filter To URL', 'dpppp-dp-portfolio-posts-pro' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
					'off' => __( 'No', 'dpppp-dp-portfolio-posts-pro' ),
				...
				'tab_slug'        => 'general',
				'toggle_slug'     => 'filters',
				'description'     => __( '...', 'dpppp-dp-portfolio-posts-pro' ),
			),
			/*
			 * Elements
			 */
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		if ( $props['show_thumbnail'] === 'on' && $props['use_overlay'] === 'on' ) {
			if ( '' !== $props['zoom_icon_color'] ) {
				ET_Builder_Element::set_style( $render_slug, array(
					'selector'    => '%%order_class%% .et_overlay:before',
					'declaration' => sprintf(
						'color: %1$s !important;', esc_html( $props['zoom_icon_color'] )
					),
				) );
			}
			if ( '' !== $props['hover_overlay_color'] ) {
				ET_Builder_Element::set_style( $render_slug, array(
					'selector'    => '%%order_class%% .et_overlay',
					'declaration' => sprintf(
						'background-color: %1$s;', esc_html( $props['hover_overlay_color'] )
					),
				) );
			}
		 ...
		 */
		ob_start();
		$posts_data = Dp_Portfolio_Posts_Pro_Utils::get_posts_data( $props, 'filterable' );
		...
		} else if ( '' !== $props['default_filter'] ) {
			$active_filter = get_term( $props['default_filter'] )->slug;
		}
		/*
		 * Build custom class for module wrapper
		 */
		if ( $props['fullwidth'] === 'on' ) {
			$layout_class = 'et_pb_filterable_portfolio_fullwidth';
		} elseif ( $props['fullwidth'] === 'off' ) {
			$layout_class = 'et_pb_filterable_portfolio_grid clearfix';
		} else {
			$layout_class = 'et_pb_portfolio_list';
		}
		$this->add_classname(
			array(
				'dp_ppp_module et_pb_filterable_portfolio',
				$layout_class,
		 ...
		 * Module output
		 */
		$output = sprintf( '<div class="et_pb_portfolio_filters clearfix"%5$s data-posts-number="%6$s" data-filter="%8$s" data-use-filters-url="%7$s">%1$s</div><div class="et_pb_portfolio_items_wrapper%3$s"><div class="et_pb_portfolio_items">%2$s</div></div>%4$s',
			$posts_data['filters'],
			$posts,
			( $props['show_pagination'] === 'on' ) ? ' clearfix' : ' no_pagination',
			( $props['show_pagination'] === 'on' ) ? '<div class="et_pb_portofolio_pagination"></div>' : '',
			is_rtl() ? ' data-rtl="true"' : '',
			esc_attr( $props['posts_number'] ),
			$props['use_filters_url'],
			$active_filter
		);
